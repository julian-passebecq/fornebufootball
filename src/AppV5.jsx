...
export default function AppV5() {
  ...
  const teamNumber = selectedTeam?.number || Math.max(1, teams.findIndex(team => team.id === selectedTeam?.id) + 1)
  ...
  return <div className={`app-shell ${coachMode ? 'coach-shell' : 'public-shell'}`}>
    <header className="topbar v5-topbar">
      ...
      <div className="team-ribbon v5-team-ribbon" aria-label="Team selection">
        <div className="team-tabs v5-team-tabs">
        ...
        <div className="next-game-ribbon v5-next-game">
    ...
    <main>
      <div className="workspace-grid">
        <section className="board-card">
          <div className="board-heading v5-board-heading">
            <div>
              <span className="eyebrow">{selectedTeam.name}</span>
              <div className="formation-heading"><h2>{formation}</h2><span>{formationShape}</span></div>
            </div>
        ...
        <aside className="strategy-sidebar">
          <div className="sidebar-brand-row v5-sidebar-brand-row">
            <TeamNumber number={teamNumber} className="sidebar-team-number"/>
          ...
          {strategyButtons.length > 1 && <div className="strategy-toggle v5-plan-switch">
