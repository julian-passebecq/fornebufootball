...
export const seedData = {
  ...
  '9v9': {
    ...
    global: global9,
    players: [
      p(1, 'Keeper', 'Goalkeeper', 7, 50, 'Start angrep med ro og se etter overtall.', 'Start attacks calmly and look for numerical superiority.', 'Organiser bakre ledd og stå klart for gjennomspill.', 'Organise the back line and be ready for through balls.', 'Etter redning: vurder rask kontra eller kontroll.', 'After a save: assess quick counter versus controlled restart.', 'Vær lagets stemme bakfra.', 'Be the team voice from the back.'),
      p(2, 'Venstre back', 'Left back', 25, 20, 'Bredde tidlig og overlapp når kanten går inn.', 'Provide early width and overlap when the winger moves inside.', 'Steng innsiden og press ut.', 'Close the inside and press outside.', 'Sprint tilbake i bakre ledd.', 'Sprint back into the defensive line.', 'Timing før fart.', 'Timing before speed.'),
      p(3, 'Midtstopper venstre', 'Left centre-back', 24, 40, 'Spill gjennom ledd når du kan, ellers flytt ballen raskt.', 'Play through lines when possible, otherwise move the ball quickly.', 'Hold linjen og dekk rom bak backen.', 'Hold the line and cover behind the full-back.', 'Sikre første kontringsløp.', 'Secure the first counterattacking run.', 'Snakk med back og keeper.', 'Talk to the full-back and goalkeeper.'),
      p(4, 'Midtstopper høyre', 'Right centre-back', 24, 60, 'Vær et sikkert pasningspunkt og før frem i ledig rom.', 'Be a secure passing option and carry into open space.', 'Kontroller dybden og vinn første duell.', 'Control depth and win the first duel.', 'Bli sentralt når andre støter.', 'Stay central when others step out.', 'Se både ball og spiss.', 'See both ball and striker.'),
      p(5, 'Høyre back', 'Right back', 25, 80, 'Støtt kanten og bruk bredde for å skape to-mot-én.', 'Support the winger and use width to create 2v1s.', 'Press utsiden og sikre innsiden sammen med stopper.', 'Press outside and protect inside with the centre-back.', 'Reager raskt på balltap.', 'React quickly when possession is lost.', 'Avstand til stopper.', 'Distance to centre-back.'),
      p(6, 'Sentral midtbane', 'Central midfielder', 48, 39, 'Spill mellom pressledd og vend spillet når én side er full.', 'Play between pressure lines and switch when one side is crowded.', 'Skjerm sentralt og støtt første press.', 'Screen centrally and support the first press.', 'Vær først på andreball.', 'Be first to the second ball.', 'Skann før mottak.', 'Scan before receiving.'),
      p(7, 'Offensiv midtbane', 'Attacking midfielder', 52, 61, 'Finn rom mellom ledd og kombiner nær boksen.', 'Find space between the lines and combine near the box.', 'Steng pasning inn sentralt og press ballfører bakfra.', 'Close central passes and press the ball carrier from behind.', 'Løp frem ved ballvinning.', 'Run forward on regaining possession.', 'Motta på halvvendt fot.', 'Receive half-turned.'),
      p(8, 'Venstre kant', 'Left winger', 68, 23, 'Utfordre 1v1 og angrip bakre stolpe når ballen er på motsatt side.', 'Attack 1v1 and arrive at the far post when the ball is on the opposite side.', 'Fall ned i riktig høyde og hjelp backen.', 'Recover to the right height and help the full-back.', 'Første løp i bakrom.', 'First run threatens in behind.', 'Bredde til rett tid.', 'Width at the right time.'),
      p(9, 'Spiss / høyre front', 'Striker / right forward', 76, 66, 'Bind stopperne og vær tydelig i boksen.', 'Occupy the centre-backs and be decisive in the box.', 'Led presset og gjør banen smal.', 'Lead the press and make the pitch narrow.', 'Hold ballen hvis vi er alene, angrip bakrom hvis støtte kommer.', 'Hold the ball if isolated; attack in behind when support arrives.', 'Vær foran mål når innlegget kommer.', 'Be in front of goal when the cross arrives.'),
    ]
  }
}
